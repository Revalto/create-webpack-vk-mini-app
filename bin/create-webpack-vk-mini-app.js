...
if (showHelp) {
	console.error(`🖖 Usage:
1️⃣ Create VK Mini App with @vkontakte/vk-miniapps-deploy deploy: ${chalk.bold.green('create-webpack-vk-mini-app <app-directory-name>')}
2️⃣ Create VK Mini App with Zeit deploy: ${chalk.bold.green('create-webpack-vk-mini-app <app-directory-name> --zeit')}
3️⃣ Create VK Mini App with Surge deploy: ${chalk.bold.green('create-webpack-vk-mini-app <app-directory-name> --surge <surge-domain>')}`);
	return;
}
